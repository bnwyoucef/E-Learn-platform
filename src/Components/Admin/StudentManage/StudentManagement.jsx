...
const StudentManagement = () => {
  ...
  return (
    <div style= {{marginLeft:'10px',overflow: 'hidden',borderRadius: '10px',backgroundColor: 'white',height: '28vh',border:'1px solid #E5E5E5'}}>
      ...
      <Box sx={{ minWidth: 120 }}>
        <TextField
          ...
          style={{ backgroundColor:'rgba(15,76,117,0.07)',borderRadius:'10px',color:'rgba(15, 76, 117, 0.6)'}}
